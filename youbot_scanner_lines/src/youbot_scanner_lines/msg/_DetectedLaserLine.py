"""autogenerated by genpy from youbot_scanner_lines/DetectedLaserLine.msg. Do not edit."""
import sys
...
class DetectedLaserLine(genpy.Message):
  _md5sum = "eb1994ee5c7013030bed8dc5bb23a3b4"
  _type = "youbot_scanner_lines/DetectedLaserLine"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """#a point on the line
float64 pointX
float64 pointY
float64 pointZ
...
"""
  __slots__ = ['pointX','pointY','pointZ','directionX','directionY','directionZ','pointCount','cloud']
  _slot_types = ['float64','float64','float64','float64','float64','float64','int32','sensor_msgs/PointCloud2']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       pointX,pointY,pointZ,directionX,directionY,directionZ,pointCount,cloud
    ...
    """
    if args or kwds:
      super(DetectedLaserLine, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.pointX is None:
        self.pointX = 0.
      if self.pointY is None:
        self.pointY = 0.
      if self.pointZ is None:
        self.pointZ = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_6di3I.pack(_x.pointX, _x.pointY, _x.pointZ, _x.directionX, _x.directionY, _x.directionZ, _x.pointCount, _x.cloud.header.seq, _x.cloud.header.stamp.secs, _x.cloud.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pointX, _x.pointY, _x.pointZ, _x.directionX, _x.directionY, _x.directionZ, _x.pointCount, _x.cloud.header.seq, _x.cloud.header.stamp.secs, _x.cloud.header.stamp.nsecs,) = _struct_6di3I.unpack(str[start:end])
      start = end
      end += 4
