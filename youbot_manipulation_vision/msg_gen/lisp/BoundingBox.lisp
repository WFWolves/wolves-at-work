...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name youbot_manipulation_vision-msg:<BoundingBox> is deprecated: use youbot_manipulation_vision-msg:BoundingBox instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader youbot_manipulation_vision-msg:position-val is deprecated.  Use youbot_manipulation_vision-msg:position instead.")
  (position m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BoundingBox>)))
  ...
  (cl:format cl:nil "#Top-left corner of the bounding box~%geometry_msgs/Point position~%~%#The width of the bounding box~%float64 width~%#The height of the bounding box~%float64 height~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BoundingBox)))
  "Returns full string definition for message of type 'BoundingBox"
  (cl:format cl:nil "#Top-left corner of the bounding box~%geometry_msgs/Point position~%~%#The width of the bounding box~%float64 width~%#The height of the bounding box~%float64 height~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
